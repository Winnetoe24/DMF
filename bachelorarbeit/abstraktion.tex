...
enum IpAddr {
    ...
    Der ``Info''-Record enthält die Zuweisung zwischen dem Enum-Eintrag und einer Instanz des Details-Interfaces. (Für Beispiel siehe \ref{TODO})\\ % TOOD Ref fertig machen
