...
\subparagraph{Modellelemente erweitern} Das \acrshort{dmf} beinhaltet die Möglichkeit Elemente zu erweitern.
...
\end{lstlisting}
Besonders bei der `entity_block'-Regel ist, dass sie direkt die `struct_content'-Regel verwendet.
