...
type FileChangeListener interface {
    ...
    Der SematicTokensService implementiert die Methode für die semantischen Tokens (für Definition siehe Abschnitt \nameref{subsubsec:semantic}).
    ...
    Diese müssen nun codiert werden.
    \begin{lstlisting}[language=Go, cpation=semantisches Element, label=lst:semantic-element]
