...
newServer.MessageLoop()
    \end{lstlisting}
    Wenn der Prozess nicht von der \acrshrot{ide} verwaltet werden kann und der Server zentral gehostet werden soll, können \acrshort{tcp}-Sockets genutzt werden.
...
for {
    ...
    Die Suche nach \textbf{Typen} wird wie d
%%    TODO erklären
