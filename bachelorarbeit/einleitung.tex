...
\lstdefinelanguage{Typescript}{
    morekeywords=[1]{typeof, new, this, as, from, catch, function, return, catch, switch, var, if, in, while, do, else, case, break, const, import, export, interface, class, enum, constructor, extends},
    morekeywords=[2]{true, false, null},
    morekeywords=[3]{int,byte,double,void,boolean, string, date, datetime, number,integer, array, object, },
