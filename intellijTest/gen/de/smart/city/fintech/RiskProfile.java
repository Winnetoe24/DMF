...
public class RiskProfile implements RiskAssessable {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(creditScore, entity.creditScore)  && Objects.equals(defaultProbability, entity.defaultProbability)  && Objects.equals(riskIndicators, entity.riskIndicators)  && Objects.equals(lastAssessment, entity.lastAssessment) ;
    }

    @Override
    public int hashCode() {
        return Objects.hash(creditScore, defaultProbability, riskIndicators, lastAssessment);
    }
}