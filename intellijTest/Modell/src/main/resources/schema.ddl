...
create table TransportRoute_segments (
    ...
    PRIMARY KEY(routeId, endPoint_latitude, endPoint_longitude, endPoint_altitude, endPoint_addressString, distance, estimatedTimeMinutes, startPoint_latitude, startPoint_longitude, startPoint_altitude, startPoint_addressString)
);
