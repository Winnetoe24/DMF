...
public class AirQualityReading {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(exceedsLimit, entity.exceedsLimit)  && Objects.equals(pollutant, entity.pollutant)  && Objects.equals(concentration, entity.concentration)  && Objects.equals(timestamp, entity.timestamp) ;
    }

    @Override
    public int hashCode() {
        return Objects.hash(exceedsLimit, pollutant, concentration, timestamp);
    }
}